...
export const metadata: Metadata = {
  ...
  description:
    "How The Looks Lab collects, uses and discloses your personal information when you visit, use our services, or make a purchase.",
};
...
export default function PrivacyPage() {
  return (
    <PolicyLayout
      ...
      intro={`This Privacy Policy describes how The Looks Lab (the “Site”, “we”, “us”, or “our”) collects, uses, and discloses your personal information when you visit, use our services, or make a purchase from thelookslab.com (the “Site”) or otherwise communicate with us regarding the Site (collectively, the “Services”). For purposes of this Privacy Policy, “you” and “your” means you as the user of the Services, whether you are a customer, website visitor, or another individual whose information we have collected pursuant to this Privacy Policy. Please read this Privacy Policy carefully.`}
    >
      ...
      <PolicySection heading="How We Collect and Use Your Personal Information">
        <p>
          ...
          set out below. The information that we collect and use varies depending
      ...
      <PolicySection heading="What Personal Information We Collect">
        <p>
      ...
      <PolicySection heading="How We Use Your Personal Information">
        <ul className="list-disc space-y-2 pl-5">
          <li>
            ...
            to your account, purchases, returns, exchanges or other transactions,
            to create, maintain and otherwise manage your account, to arrange for
            shipping, facilitate any returns and exchanges and other features and
          ...
          <li>
            ...
            our Site and other websites. If you are an EEA resident, the legal
            basis for these data processing activities is our legitimate interest
            in selling our products, according to Art. 6 (1) (f) GDPR.
          </li>
          <li>
            <strong className="font-semibold text-graphite">
            ...
            compromised, please contact us immediately. If you are an EEA
            resident, the legal basis for these data processing activities is our
            legitimate interest in keeping our website secure for you and other
            customers, according to Art. 6 (1) (f) GDPR.
          </li>
          <li>
            <strong className="font-semibold text-graphite">
            ...
            and to maintain our business relationship with you according to Art.
            6 (1) (f) GDPR.
          </li>
        </ul>
      </PolicySection>
      ...
      <PolicySection heading="Cookies">
        <p>
          ...
          information about the Cookies that we use related to powering our store
          with Shopify, see{" "}
          <a
      ...
      <PolicySection heading="How We Disclose Personal Information">
        <p>
          ...
          and other reasons subject to this Privacy Policy. Such circumstances may
          include:
        </p>
        <ul className="list-disc space-y-2 pl-5">
          <li>
          ...
          <li>
            ...
            requests), to enforce any applicable terms of service, and to protect
        ...
        <p>
          ...
          personal information and sensitive personal information about users for
        ...
        <p>
          These categories were disclosed to vendors and third parties who
          perform services on our behalf (such as Internet service providers,
          payment processors, fulfillment partners, customer support partners and
          data analytics providers), business and marketing partners, and
          affiliates.
        </p>
        <p>
        ...
        <p>
          ...
          engaging in advertising and marketing activities, as follows. We have
          “sold” and “shared” (as those terms are defined in applicable law)
        ...
        <ul className="list-disc space-y-2 pl-5">
          <li>
            Identifiers such as name, e-mail address and phone number — disclosed
            to business and marketing partners.
          </li>
          <li>
            Commercial information such as records of products or services
            purchased — disclosed to business and marketing partners.
          </li>
          <li>Usage Data — disclosed to business and marketing partners.</li>
        </ul>
      </PolicySection>
      ...
      <PolicySection heading="Third Party Websites and Links">
        <p>
          ...
          the accuracy, completeness, or reliability of information found on these
      ...
      <PolicySection heading="Security and Retention of Your Information">
        <p>
      ...
      <PolicySection heading="Your Rights">
        ...
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>
            ...
            hold about you and to request that we transfer it to a third party,
          ...
          <li>
            <strong className="font-semibold text-graphite">Appeal:</strong> You
            may have a right to appeal our decision if we decline to process your
        ...
        <p>
          ...
          laws, you may designate an authorized agent to make requests on your
          behalf to exercise your rights. Before accepting such a request from an
          agent, we will require that the agent provide proof you have authorized
          them to act on your behalf, and we may need you to verify your identity
      ...
      <PolicySection heading="Complaints">
        <p>
          ...
          your local data protection authority. For the EEA, you can contact your
