...
export const metadata: Metadata = {
  ...
  description:
    "How The Looks Lab collects, uses and protects your personal information when you browse and buy cinematic LUT packs.",
};
...
export default function PrivacyPage() {
  return (
    <PolicyLayout
      ...
      intro="This Privacy Policy describes how The Looks Lab (“we”, “us”, “our”) collects, uses and shares information when you visit our store, create an account, or purchase a LUT pack."
    >
